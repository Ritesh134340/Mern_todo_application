        ...
        <div className="main-div">
          {
            data && data.map((ele)=>{
             ...
             {/* style={{transform:ele._id===dis?"rotateY(180deg)":"rotateY(0deg)"}}  */}
                        <div className="upper-card-div" style={{display:dis===ele._id?"none":"block",width:"100%",height:"100%"}}>
                        <div className="title-div" >
                          <ImageWrapperDiv stat={ele.status}>
                         <h3>{ele.status.toUpperCase()}</h3>
                          <div className="img-div"><h5>{ele.date}</h5> <h5>{ele.time}</h5>
                         </div>
                         </ImageWrapperDiv>
                        ...
                        <label>TITLE</label>
                         ...
                         <h4>{ele.category}</h4>
                         <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",width:"100%",boxSizing:"border-box",marginTop:"0px",marginBottom:"0px",paddingTop:"0px",paddingBottom:"0px"}}>
                         ...
                         <div>
                         <button style={{cursor:"pointer", padding:'8px 0px',backgroundColor:"white",fontWeight:"700",border:"none",fontSize:"14px",fontFamily:"sans-serif",display:"flex",alignItems:"center",gap:"5px"}} onClick={()=>handleDis(ele._id)}className="dis-button">Description <MdOutlineDescription style={{fontSize:"18px",color:"rgb(0,117,255)",backgroundColor:"rgb(242,253,255)",borderRadius:"50%",padding:"5px"}}/> </button>
                         </div>
                           </div>
                        ...
                        <button><Link style={{color:"white",textDecoration:"none"}} to={`/todo/edit/${ele._id}`}>UPDATE</Link></button>
                         ...
                         <div className="des-div"  style={{display:ele._id===dis?"block":"none"}}  >
                           <h3>{ele.description? ele.description : "No description is added."}</h3>
