...
const Home = () => {
  ...
  const handleSubDel = (idValue) => {
    let result = subTask.filter((ele) => ele.id !== idValue);
       ...
       {isLoading ? <Loading/> : <MainHomeDiv>
          ...
          <HomeTopDiv>
            ...
            <div className="common-addtask">
              ...
              />
              <br />
              <button className="task-del" onClick={handleAddSub}>
                Add Subtask
              </button>
              <div className="sub-holder">
                {subTask &&
                  subTask.map((ele, index) => (
                    <div className="del-btn" key={index}>
                      <h5>{ele.subtask}</h5>
                      <button
                        style={{ border: "1px solid rgb(216,219,224)" }}
                        onClick={() => handleSubDel(ele.id)}
                      >
            ...
            <div className="common-date">
              ...
              <button id="btn-holder" onClick={handleAddTodo}>
                Create New Task
              </button>
            </div>
          </HomeTopDiv>
